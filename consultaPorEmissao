<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $consulta = mysqli_query($conexao, "SELECT * FROM notas_fiscais WHERE Data_emissao = '$dataemissao'");
...
<html>
    ...
    <body>
        ...
        <main>
            <h1>Consultar Nota por Data de Emissão</h1>
            <form action="consultaPorEmissao.php" method="post">

                <fieldset>
                    <label for="emissao">Data de Emissão</label>: <br>
            ...
            <?php if(isset($_POST['submit'])) { ?>
                ...
                <?php } else { ?>
                    <a>Não há nenhuma nota cadastrada no Sistema com essa data de emissão.</a>   
                <?php } ?>
            <?php } ?>
